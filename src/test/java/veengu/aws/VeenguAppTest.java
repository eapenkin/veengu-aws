...
public class VeenguAppTest {
    ...
    public void pipelineStack() {
        ...
        PublishPipeline publishPipeline = new PublishPipeline(app, "test-pipe", "test-branch", 8080, gitRepository.getRepository(), dockerRegistry.getRegistry(), fargateCluster.getService(), fargateCluster.getTaskDefinition());
    }
}
